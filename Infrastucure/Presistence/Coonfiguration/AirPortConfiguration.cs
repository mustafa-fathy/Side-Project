...
namespace Infrastructure.Presistence.Coonfiguration
{
    public class AirPortConfiguration : IEntityTypeConfiguration<Airport>
    {
        public void Configure(EntityTypeBuilder<Airport> builder)
        {
            ...
            builder.Property(p => p.CreationDate).HasColumnName("DATETIME").HasDefaultValueSql("GETDATE()").IsRequired();
            builder.Property(p => p.ModificationDate).HasColumnName("DATETIME");
